...
// Try to import Vercel KV / Upstash Redis
let kv = null
...
if (hasUpstashVars || hasVercelKVVars) {
  try {
    // Dynamic import for Vercel KV (works with Upstash)
    const kvModule = await import('@vercel/kv')
    
    // Create KV client with Upstash credentials if available
    if (hasUpstashVars) {
