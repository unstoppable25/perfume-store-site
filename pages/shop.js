  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white">
        ...
        <footer className="bg-gray-900 text-white py-2 sm:py-4 mt-4">
          <div className="max-w-7xl mx-auto px-1 sm:px-2 lg:px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-6 mb-2 md:mb-6">
              <div>
                <h3 className="text-xs sm:text-lg font-bold mb-1 sm:mb-2">SCENTLUMUS</h3>
                <p className="text-gray-400 text-[10px] sm:text-xs">
                  Your premier destination for luxury fragrances.
                </p>
              </div>
              <div>
                <h3 className="text-xs sm:text-base font-semibold mb-1 sm:mb-2">Quick Links</h3>
              ...
              <div>
                <h3 className="text-xs sm:text-base font-semibold mb-1 sm:mb-2">Follow Us</h3>
