            ...
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="https://api.whatsapp.com/send?phone=2347035805171" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition" title="WhatsApp">
